...
const UserDetailsButton: React.FC<UserDetailsButtonProps> = ({
  ...
  const user = {
    name: "Mithula",
    email: "mithula@example.com",
    avatarUrl: "", // Placeholder or real image
  };
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="w-64 px-4 pb-4 rounded-xl shadow-lg">
        <DropdownMenuLabel>
        ...
        >
          ...
          <span className="text-lg  text-header-catbtn hover:text-header-catbtnhover transition-colors">Log out</span>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
